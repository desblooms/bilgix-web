...
<div class="mb-6">
    ...
    <div class="mb-4">
        <div class="relative">
            <input type="text" id="searchInput" class="w-full pl-10 pr-4 py-2 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Search invoice or customer...">
    ...
    <div class="bg-white rounded-lg shadow p-6 text-center">
        ...
        <a href="add.php" class="inline-block bg-blue-600 text-white py-2 px-6 rounded-lg">Create Your First Sale</a>
    </div>
    <?php endif; ?>
</div>
