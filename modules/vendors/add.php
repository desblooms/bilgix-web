...
<div class="mb-6">
    ...
    <form method="POST" class="bg-white rounded-lg shadow p-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="contactPerson" name="contactPerson" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= isset($_POST['contactPerson']) ? $_POST['contactPerson'] : '' ?>">
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="text" id="gstNumber" name="gstNumber" class="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= isset($_POST['gstNumber']) ? $_POST['gstNumber'] : '' ?>">
        </div>
